...
export const GuestCard = styled.div`
  background-color: ${(props) =>
    props.status === "Pago" ? "white" : "#9ac7be"};
  display: flex;
  flex-direction: column;
...
export const GuestName = styled.span`
  color: ${(props) => (props.status === "Pago" ? "black" : "white")};
  font-size: 16px;
  font-weight: 600;
  margin-top: 4px;
`;
...
export const GuestService = styled.span`
  background-color: ${(props) =>
    props.status === "Pago" ? "#3d786c" : "white"};
  color: ${(props) => (props.status === "Pago" ? "white" : "#9ac7be")};
  font-size: 12px;
  font-weight: 500;
  padding: 2px 14px;
  border-radius: 8px;
...
export const OccupantService = styled.span`
  background-color: ${(props) =>
    props.service === "Tosa" ? "#3d786c" : "darkorange"};
  color: white;
  padding: 2px 14px;
  border-radius: 6px;
`;
